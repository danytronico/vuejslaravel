<template>
    <v-app>
        ...
        <img src="../../../../public/images/carousel-08.jpg" class="images04" data-aos="fade">
        ...
        <v-card color="#FFFFFF" flat>
            ...
            <v-layout row wrap justify-center>
                <v-flex xs6 sm5 md3>
                    ...
                    <v-card-title class="cas" data-aos="fade">Devocionales de la iglesia</v-card-title>
                    ...
                    <template v-slot:item="props">
                        ...
                        <v-flex d-flex xs12 sm6 md4 lg4 >
                            ...
                            <v-container class="pad">
                                ...
                                <v-card color="#C5D5E1" class="hey" data-aos="fade">
                                    <v-layout>

                                        <v-flex xs12 sm12 md12>
                                            <img :src="'data:image/jpeg;base64,'+props.item.imagen"  class="images02" >

                                            <v-card-title class="predicas3">{{props.item.titulo}}</v-card-title>

                                            <v-card-text>{{props.item.descripcion}}</v-card-text>

                                            <v-card-text>{{props.item.pastor}}</v-card-text>

                                            <v-divider></v-divider>


                                            <v-card-text>{{moment(props.item.created_at).format('DD/MM/YYYY HH:mm')}}</v-card-text>

                                            <v-btn color="rgb(63, 81, 181)" style="font-size: 10px" dark @click="onSelectionChanged(props.item)">Ver Detalle
                                            </v-btn>
        ...
        <v-dialog v-model="dialog" persistent max-width="600">
            <v-card>
                <v-container>
                    ...
                    <v-layout row wrap justify-center>
                        <v-flex xs12 sm6 md6>
                            <v-card-title class="emp">Datos del Devocional</v-card-title>
    ...
    export default {
        ...
        methods:{
            ...
            getmenber(){
                ...
                this.axios.get('./api/predica/index2',{
            ...
            onSelectionChanged(faiz){
                ...
                this.lista.descripcion = faiz.descripcion;
                this.lista.pastor = faiz.pastor;
                this.lista.link = faiz.link;
