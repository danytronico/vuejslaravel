<template>
    <v-app>
        ...
        <img src="../../../../public/images/carouselmatrimonio-12.jpg" class="images04" data-aos="fade">
        ...
        <v-card  color="#FFFFFF" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/matri01.jpeg" class="images06">


                    <v-card-title class="emp">Ministerio de Matrimonio</v-card-title>

                    <v-card-text class="lettle">
                        La Red de Matrimonios de la Iglesia Cristiana Palabras de Vida es una maravillosa estrategia dada por Dios a nuestros pastores y líderes para que matrimonios dañados a nivel físico, moral y espiritual, conozcan el verdadero plan de Dios para ellos, lo apliquen a sus vidas y sean de impacto a otros matrimonios en nuestra iglesia y en toda nuestra Republica Dominicana, declarando que Jesús es el centro de nuestra relación de parejas y de nuestras vidas.
        ...
        <v-card  color="#CFE0E8" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/orig_769786.jpg" class="images05">


                    <v-card-title class="emp">Caracteristicas</v-card-title>

                    <ul class="lettle">
                        <li>Que en nuestra iglesia haya matrimonios fuertes espiritualmente, teniendo a Cristo como su centro.</li>
                        <li>Proporcionar a los matrimonios un espacio donde puedan ser atendidos y crecer en el Señor.
                        </li>
                        <li> Convertirnos en una red de impacto, modelando a Cristo a todos los matrimonios que nos rodean.
                        </li>
    ...
    export default {
        ...
        methods:{
            ...
            getmenber(){
                ...
                this.axios.get('./api/minisgalery/index3',{
