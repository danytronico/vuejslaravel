<template>
    <v-app>
        ...
        <img src="../../../../public/images/carousel-10.jpg" class="images04" data-aos="fade">
        ...
        <v-card  color="#FFFFFF" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/foto3.jpg" class="images06">


                    <v-card-title class="emp">Ministerio de Mujeres</v-card-title>

                    <v-card-text class="lettle">
                        Un Ministerio de mujeres debe estar bajo la supervisión, dirección y liderazgo del pastor o CONSEJO de pastores de la iglesia.
                        Se debe pasar un tiempo en oración para que el Señor muestre la mujer encargada que cuente con los dones de administrar y de organizar.
        ...
        <v-card  color="#CFE0E8" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/foto6.jpg" class="images05">


                    <v-card-title class="emp">Caracteristicas</v-card-title>

                    <ul class="lettle">
                       <li> Con espíritu humilde y enseñable</li>
                        <li> Con conocimiento de teología sólida y sana DOCTRINA en la BIBLIA</li>
                        <li> Dones de administración</li>
                        <li> Con espíritu humilde y enseñable</li>
                        <li>Dirigir grupos pequeños</li>
                        <li>Clases de teología para mujeres presenciales u on-line</li>
    ...
    export default {
        ...
        methods:{
            ...
            getmenber(){
                ...
                this.axios.get('./api/minisgalery/index2',{
