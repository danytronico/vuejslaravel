<template>
    <v-app>
        ...
        <img src="../../../../public/images/carousel2-11.jpg" class="images04" data-aos="fade">
        ...
        <v-card  color="#FFFFFF" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/imagendefinicion.jpg" class="images06">


                    <v-card-title class="emp">Ministerio de Niños</v-card-title>
        ...
        <v-card  color="#CFE0E8" data-aos="fade">
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12>
                    <img src="../../../../public/images/imagencaracteristicas.jpg" class="images05">


                    <v-card-title class="emp">Caracteristicas</v-card-title>

                    <ul class="lettle">
                        <li>Niños de 3 a 4 años:

                            Los niños en edad preescolar aprenden en sus primeros pasos acerca de Jesús con juegos, canciones y meriendas;</li>
                        <li>Niños de 5 a 6 años:
                            Desde esta temprana edad ya se les enseña a crear una relación con Cristo, entendiendo y memorizando versículos claves de la Biblia y encontrando una mayor participación en las historias bíblicas.
                        </li>
                        <li> Niños de 10 a 12 años:
                            Nosotros guiamos a los niños con discusiones acerca de un pasaje bíblico, juegos y dramas para ofrecerles herramientas para fortificar una vida cristiana, pero solo por medio de Dios es que tendrán sabiduría.
                        </li>
        ...
        <div class="heights">
            ...
            <v-layout row wrap justify-center>
                ...
                <v-flex xs12 sm6 md3>
                    <v-card-title class="emp">Galeria de imagenes</v-card-title>
                </v-flex>
            </v-layout>
                    ...
                    <v-flex d-flex xs12 sm6 md4 lg4 >
                        ...
                        <v-container class="pad">
                            ...
                            <v-layout>
                                ...
                                <v-flex xs12 sm12 md12>
                                    <img :src="'data:image/jpeg;base64,'+props.item.imagen" @click="onSelectionChanged(props.item)" style="cursor: pointer" class="images02" data-aos="fade" >
    ...
    export default {
        ...
        methods:{
            ...
            getmenber(){
                ...
                this.axios.get('./api/minisgalery/index5',{
