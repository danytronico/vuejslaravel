            ...
            <v-container>
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        ...
                        <v-layout row wrap>
                            <v-flex xs12 sm9 md9>
                                <v-card-title class="emp">Registros de Notificaciones</v-card-title>
        ...
        <v-dialog v-model="dialog" persistent max-width="400">
            <v-card>
                <v-layout row wrap justify-center>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Datos de las notificaciones</v-card-title>
    ...
    export default {
        ...
        beforeMount() {
            ...
            this.columnDefs = [
                ...
                {
                    headerName: 'Titulo', field: 'titulo', filter: "agTextColumnFilter",width:150
                },

                {
                    headerName: 'Tabla de origen', field: 'tabla', filter: "agTextColumnFilter",width:200
                },
        ...
        methods:{
            ...
            getmenber(){
                ...
                this.axios.get('./api/noticia/index2',{
            ...
            onSelectionChanged(){
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let rowSelected3 = this.rowData[i].tabla;
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        if (respuesta) {
                            ...
                            let rowSelected =this.rowData[i].id;
                            let uri = `./api/noticia/delete/${rowSelected}`;
            ...
            imprimir(){
                ...
                doc.setFontSize(20);
                doc.text(300,125,"Registro de notificaciones");
