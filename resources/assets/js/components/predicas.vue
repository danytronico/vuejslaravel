<template>
    <v-app>
        ...
        <img src="../../../../public/images/carousel-07.jpg" class="images04" data-aos="fade">
        ...
        <v-card color="#FFFFFF" flat>
            ...
            <v-layout row wrap justify-center>
                <v-flex xs6 sm5 md3>
                    ...
                    <v-card-title class="cas" data-aos="fade">Predicas de la iglesia</v-card-title>
