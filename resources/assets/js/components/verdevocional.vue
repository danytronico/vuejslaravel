    ...
    <v-app>
            ...
            <v-container>
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        ...
                        <v-layout row wrap>
                            <v-flex xs12 sm6 md6>
                                <v-card-title class="emp">Registros de Devocionales</v-card-title>
                            ...
                            <v-flex xs12 sm5 md5>
                                ...
                                <v-btn color="rgb(63, 81, 181)" style="font-size: 10px" dark @click="dialog2 = true">Agregar Devocional
                                </v-btn>
        ...
        <v-dialog v-model="dialog" persistent max-width="600">
            <v-card>
                <v-container>
                    ...
                    <v-layout row wrap>
                        <v-flex xs12 sm12 md12>
                            <v-card-title class="emp">video Devocional</v-card-title>
        ...
        <v-dialog v-model="dialog2" persistent max-width="800">
            <v-card>
                <v-layout row wrap justify-center>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Formulario para crear los Devocionales</v-card-title>
    ...
    export default {
        ...
        methods:{
            ...
            imprimir(){
                ...
                doc.setFontSize(20);
                doc.text(300,125,"Registro de Devocionales");
