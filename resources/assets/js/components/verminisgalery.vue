    ...
    <v-app>
            ...
            <v-container>
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        ...
                        <v-layout row wrap>
                            <v-flex xs12 sm6 md6>
                                <v-card-title class="emp">Registros de Imagenes de los Ministerios</v-card-title>
                            ...
                            <v-flex xs12 sm5 md5>
                                ...
                                <v-btn color="rgb(63, 81, 181)" style="font-size: 10px" dark @click="dialog2 = true">Agregar Imagen
                                </v-btn>
            ...
            <v-card>
                <v-container>
                    ...
                    <v-layout row wrap justify-center>
                        <v-flex xs12 sm6 md6>
                            <v-card-title class="emp">Datos de la Imagen</v-card-title>
                    ...
                    <v-layout row wrap>
                        <v-flex xs12 sm12 md12>
                            <v-card-title class="emp">Ministerio</v-card-title>
                            <v-card-text class="empeor">
                                {{lista.status}}
                            </v-card-text>
        ...
        <v-dialog v-model="dialog2" persistent max-width="800">
            <v-card>
                <v-layout row wrap justify-center>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Formulario para subir Imagenes de los ministerios</v-card-title>
    ...
    export default {
        ...
        data(){
            ...
            return{
                ...
                statusRules: [
                    v => !!v || 'El Ministerio es requerido',
                ],
        ...
        beforeMount() {
            ...
            this.columnDefs = [
                ...
                {
                    headerName: 'Ministerio', field: 'status', filter: "agTextColumnFilter",width:200
                },
        ...
        methods:{
            ...
            imagenrecive(faiz){
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let uri = `./api/minisgalery/image/${rowSelected}`;
            ...
            submit(){
                if (this.$refs.form.validate()) {
                    ...
                    this.axios.post('./api/minisgalery/create', logForm , {
                        headers: {
            ...
            getmenber(){
                ...
                this.axios.get('./api/minisgalery/index6',{
            ...
            onSelectionChanged(){
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let rowSelected7 = this.rowData[i].status;
                        ...
                        this.lista.status = rowSelected7
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        if (respuesta) {
                            ...
                            let rowSelected =this.rowData[i].id;
                            let uri = `./api/minisgalery/delete/${rowSelected}`;
            ...
            editar3() {
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let rowSelected = this.rowData[i].id;
                        let uri = `./api/minisgalery/update/${rowSelected}`;
            ...
            imprimir(){
                ...
                doc.setFontSize(20);
                doc.text(300,125,"Registro de Fotos del Ministerio");
