    ...
    <v-app>
            ...
            <v-container>
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        ...
                        <v-layout row wrap>
                            <v-flex xs12 sm6 md6>
                                <v-card-title class="emp">Registros de Ofrendas</v-card-title>
                            ...
                            <v-flex xs12 sm5 md5>
                                ...
                                <v-btn color="rgb(63, 81, 181)" style="font-size: 10px" dark @click="dialog2 = true">Agregar Ofrenda
                                </v-btn>
        ...
        <v-dialog v-model="dialog" persistent max-width="600">
            <v-card>
                <v-layout row wrap justify-center>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Datos de la ofrenda</v-card-title>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Apellido</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.apellido}}
                        </v-card-text>
                ...
                <v-layout row wrap>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Télefono</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.telefono}}
                        </v-card-text>
                    ...
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Cedula</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.cedula}}
                        </v-card-text>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Ocupacion</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.ocupacion}}
                        </v-card-text>
                ...
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        <v-card-title class="emp">Ofrenda</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.ofrenda}}
                        </v-card-text>
                ...
                <v-layout row wrap>
                    <v-flex xs12 sm12 md12>
                        <v-card-title class="emp">Direccion</v-card-title>
                        <v-card-text class="empeor">
                            {{lista.direccion}}
                        </v-card-text>
        ...
        <v-dialog v-model="dialog2" persistent max-width="800">
            <v-card>
                <v-layout row wrap justify-center>
                    <v-flex xs12 sm6 md6>
                        <v-card-title class="emp">Formulario para anotar las Ofrendas</v-card-title>
    ...
    export default {
        ...
        data(){
            ...
            return{
                ...
                lista:
                    {nombre:'',apellido:'',telefono:'',cedula:'',correo:'',ocupacion:'',ofrenda:'',direccion:'',tabla:'ofrendas'}
                ,
                ...
                nameRules: [
                    ...
                    v => (v && v.length <= 90) || 'El nombre debe tener un maximo 90 caracteres'
                ],
                ...
                ceduRules: [
                    ...
                    v => (v && v.length <= 90) || 'La cedula debe tener un maximo de 20 caracteres'
                ],
                ...
                ocuRules: [
                    v => !!v || 'La ocupacion es requerida',
                    v => (v && v.length <= 30) || 'La ocupacion debe tener un maximo de 30 caracteres'
                ],

                ofreRules: [
                    v => !!v || 'La ofrenda es requerida',
                    v => (v && v.length <= 299) || 'La ofrenda debe tener un maximo 300 caracteres'
                ],

                dirRules: [
                    v => !!v || 'La direccion es requerida',
                    v => (v && v.length <= 299) || 'La direccion debe tener un maximo 300 caracteres'
                ],
        ...
        beforeMount() {
            ...
            this.columnDefs = [
                ...
                {
                    headerName: 'Apellido', field: 'apellido', filter: "agTextColumnFilter",width:200
                },
                {headerName: 'Telefono', field: 'telefono', filter: "agTextColumnFilter",width:180},
                {headerName: 'Cedula', field: 'cedula', filter: "agTextColumnFilter",width:180},
                {headerName: 'Correo', field: 'correo', filter: "agTextColumnFilter",width:180},
                {headerName: 'Ocupacion', field: 'ocupacion', filter: "agTextColumnFilter",width:180},
                {headerName: 'Ofrenda', field: 'ofrenda', filter: "agTextColumnFilter",width:320},
                {headerName: 'Direccion', field: 'direccion', filter: "agTextColumnFilter",width:320},
        ...
        methods:{
            ...
            submit(){
                if (this.$refs.form.validate()) {
                    ...
                    this.axios.post('./api/ofrenda/create', logForm , {
                        headers: {
            ...
            onSelectionChanged(){
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let rowSelected3 = this.rowData[i].apellido;
                        let rowSelected4 = this.rowData[i].telefono;
                        let rowSelected5 = this.rowData[i].cedula;
                        let rowSelected6 = this.rowData[i].correo;
                        let rowSelected7 = this.rowData[i].ocupacion;
                        let rowSelected8 = this.rowData[i].ofrenda;
                        let rowSelected9 = this.rowData[i].direccion;



                        this.lista.nombre = rowSelected2

                        this.lista.apellido = rowSelected3
                        this.lista.telefono = rowSelected4
                        this.lista.cedula = rowSelected5
                        this.lista.correo = rowSelected6
                        this.lista.ocupacion = rowSelected7
                        this.lista.ofrenda = rowSelected8
                        this.lista.direccion = rowSelected9
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        if (respuesta) {
                            ...
                            let rowSelected =this.rowData[i].id;
                            let uri = `./api/ofrenda/delete/${rowSelected}`;
            ...
            editar3() {
                ...
                for(let i=0;i<this.rowData.length;i++){
                    ...
                    if(this.gridOptions.api.focusedCellController.focusedCellPosition.rowIndex === i){
                        ...
                        let rowSelected = this.rowData[i].id;
                        let uri = `./api/ofrenda/update/${rowSelected}`;
            ...
            imprimir(){
                ...
                doc.setFontSize(20);
                doc.text(300,125,"Registro de ofrendas");
